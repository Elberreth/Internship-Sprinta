...
const NewlyRegisteredUsers = () => {
  ...
  const handleReject = () => {
    const newlyRejectedUsers = checkedUsers.filter(user => !acceptedUsers.includes(user));
    setRejectedUsers([...rejectedUsers, ...newlyRejectedUsers]);
  };
    ...
    <div className="container">
      ...
      <div className="row mt-3" style={{ maxWidth: '200px', margin: 'auto' }}>
        <div className="col d-flex justify-content-center">
          ...
          <button type="button" className="btn btn-danger btn-sm" onClick={handleReject}>Reject</button>
        </div>
      </div>
      {/* Accepted Users */}
